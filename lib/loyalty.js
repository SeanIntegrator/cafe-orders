...
/**
 * Cheapest qualifying drink unit price in pence; discount = min(that, cap).
 * One free-drink reward applies to a single drink, not the full line quantity.

/**
 * Hybrid KDS list: Square board window orders merged with Postgres web_app rows.
 */
...
/**
 * @param {() => Promise<object[]>} fetchSquareOrders - e.g. square.searchKdsBoardSquareOrders or square.searchOpenOrders
 * @returns {Promise<object[]>}
 */
async function mergeKdsBoardOrdersWithWebAppDb(fetchSquareOrders) {
  let orders = await fetchSquareOrders();
...
module.exports = {
  mergeKdsBoardOrdersWithWebAppDb,

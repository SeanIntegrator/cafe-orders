...
/**
 * Single open / in-progress web_app or whatsapp order by Square id (for KDS recall overlay).
 * @param {string} squareOrderId
 * @returns {Promise<object|null>} { ...orderRow, items: itemRows[] } or null
 */
async function fetchWebAppOrderBySquareIdWithItems(squareOrderId) {
...
module.exports = {
  ...
  fetchWebAppOrderBySquareIdWithItems,
};
